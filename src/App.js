...
class App extends Component {
      ...
      PassageContract.deployed().then((instance) => {
        ...
        event.watch((error, result) => {
          if (!error){
            ...
            notify.show("Producto creado Exitosamente.", "custom", 5000, { background: '#50b796', text: "#FFFFFF" });
          } else {
            console.log(error);
          }
        });
  ...
  render() {
    ...
    const appJSX = (
      <div style={{minHeight:"100vh", borderTop:"4px solid #1D98F8", backgroundColor: "#51BBBE", fontFamily: "Barlow"}}>
        <Notifications/>
